        ...
        >
          ...
          <dd className="flex flex-wrap gap-1.5">
            {group.items.map(skill => (
              <span
                key={skill}
                className="inline-flex items-center rounded-md border border-border bg-muted/40 px-2 py-0.5 text-xs text-foreground/90 print:border-border/60 print:bg-transparent print:px-1.5 print:py-0"
              >
                {skill}
              </span>
            ))}
